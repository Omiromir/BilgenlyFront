...
export function HeroSection() {
  ...
  return (
    <section
      id="home"
      className="relative scroll-mt-24 px-4 pt-[120px] sm:px-6  sm:pt-[145px] lg:px-8 lg:pt-[163px]"
    >
      <div className="mx-auto max-w-[1200px] text-center">
        ...
        >
          Learn <span className="text-[#2191F6]">Smarter</span>, Play{" "}
          <span className="text-[#2191F6]">Harder</span> with AI
        </motion.h1>
        <motion.p
        ...
        <div className="pointer-events-none mx-auto -mt-3 h-[30px] w-full rounded-[28px] bg-white shadow-[0_24px_70px_rgba(255,255,255,1)] sm:-mt-6 sm:h-[140px] sm:rounded-[40px] sm:shadow-[0_44px_110px_rgba(255,255,255,1)]" />{" "}
      </div>
    </section>
  );
}
