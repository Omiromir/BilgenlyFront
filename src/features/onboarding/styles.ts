export const onboardingStyles = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .btn-primary { background: linear-gradient(135deg,#7C3AED,#6D28D9); color: #fff; border: none; border-radius: 10px; padding: 13px 0; width: 100%; font-size: 15px; font-weight: 600; cursor: pointer; font-family: inherit; transition: all 0.2s; letter-spacing: 0.01em; }
  ...
  .option-row { border: 1.5px solid #e2e0f0; border-radius: 12px; padding: 13px 16px; display: flex; align-items: center; gap: 12px; cursor: pointer; transition: all 0.18s; background: #fff; width: 100%; text-align: left; font-family: inherit; margin-bottom: 9px; }
  ...
  .option-row .sub { font-size: 12px; color: #888; margin-top: 1px; }
  ...
  @media (max-width: 640px) {
    ...
    .card { border-radius: 18px; padding: 24px 18px; box-shadow: 0 10px 32px rgba(109,40,217,0.08); }
    .btn-primary, .btn-outline { font-size: 14px; }
    .option-row { padding: 12px 13px; gap: 10px; }
    .option-row .label { font-size: 13px; }
    .option-row .sub { font-size: 11px; line-height: 1.4; }
